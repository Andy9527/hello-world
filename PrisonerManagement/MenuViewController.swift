...
class MenuViewController: UIViewController {
    ...
    @IBAction func menuBtn(_ sender: Any)
    {
        ...
        registrationImage.image = UIImage(named: "registration.png")
        ...
        offendersSearchImage.image = UIImage(named: "maps.png")
        ...
        offendersImage.image = UIImage(named: "people.png")
        ...
        messageImage.tintColor = UIColor.white
        //建立messageLabel物件
    ...
    //Calenar頁面跳轉
    @IBAction func CaledarBtn(_ sender: Any)
    {
        let storyboard:UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
    ...
    //Offenders頁面跳轉
    @IBAction func OffenderBtn(_ sender: Any)
    {
        let storyboard:UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
    ...
    //OffendersSearch頁面跳轉
    @IBAction func OffendersSearchBtn(_ sender: Any)
    {
