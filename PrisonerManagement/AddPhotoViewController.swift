...
class AddPhotoViewController: UIViewController {
    ...
    var vehiclesTag:Int = 1
    var printsTag:Int = 2
    var passportTag:Int = 3
    //總tag用作判別用
    var tag:Int? = nil
    
    //View物件宣告
    var picturesImageView:UIImageView!
    var vehiclesImageView:UIImageView!
    var printsImageView:UIImageView!
    var passportImageView:UIImageView!
    
    var pictureView:UIView!
    var vehiclesView:UIView!
    var printsView:UIView!
    var passportView:UIView!
    //button物件宣告
    var picturesBtn:UIButton!
    var vehiclesBtn:UIButton!
    var printsBtn:UIButton!
    var passportBtn:UIButton!
    //label物件宣告
    var pictureLabel:UILabel!
    var vehiclesLabel:UILabel!
    var printsLabel:UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //建立Button物件
        picturesBtn = UIButton(type: .contactAdd)
        //設定位置大小
        picturesBtn.frame = CGRect(x: 144.0, y: 8.0, width: 40.0, height: 40.0)
        //設定觸發事件
        picturesBtn.addTarget(self, action: #selector(pictureBtnSelector(_:)), for: .touchUpInside)
        //背景顏色
        picturesBtn.backgroundColor = UIColor.green
        //圓角
        picturesBtn.layer.cornerRadius = 10.0
        //識別碼
        picturesBtn.tag = self.pictureTag
        
        //建立pictureImageView物件
        picturesImageView = UIImageView(frame: CGRect(x: 5.0, y: 242.0, width: 200.0, height: 200.0))
        //背景顏色
        picturesImageView.backgroundColor = UIColor.gray
        //允許編輯
        self.picturesImageView.isUserInteractionEnabled = true
        //加入Button
        self.picturesImageView.addSubview(self.picturesBtn)
        picturesImageView.tag = 0
        //建立Label物件
        pictureLabel = UILabel(frame: CGRect(x: 5.0, y: 442.0, width: 200.0, height: 30.0))
        //設定文字 字型及大小
        pictureLabel.text = "PICTURES"
        pictureLabel.font = UIFont(name: "Helvetica", size: 16.0)
        
        
        //建立Button物件
        vehiclesBtn = UIButton(type: .contactAdd)
        //設定位置大小
        vehiclesBtn.frame = CGRect(x: 144.0, y: 8.0, width: 40.0, height: 40.0)
        //設定觸發事件
        vehiclesBtn.addTarget(self, action: #selector(vehiclesBtnSelector(_:)), for: .touchUpInside)
        //背景顏色
        vehiclesBtn.backgroundColor = UIColor.green
        //圓角
        vehiclesBtn.layer.cornerRadius = 10.0
        //識別碼
        vehiclesBtn.tag = self.vehiclesTag
        //建立vehiclesImageView物件
        vehiclesImageView = UIImageView(frame: CGRect(x: 209.0, y: 242.0, width: 200.0, height: 200.0))
        //允許編輯
        vehiclesImageView.isUserInteractionEnabled = true
        //背景顏色
        vehiclesImageView.backgroundColor = UIColor.gray
        //Button加入ImageView
        self.vehiclesImageView.addSubview(self.vehiclesBtn)
        
        //建立Label物件
        vehiclesLabel = UILabel(frame: CGRect(x: 209.0, y: 442.0, width: 200.0, height: 30.0))
        //設定文字 字型及大小
        vehiclesLabel.text = "VEHICLES"
        vehiclesLabel.font = UIFont(name: "Helvetica", size: 16.0)
        
        
        
        //建立Button物件
        printsBtn = UIButton(type: .contactAdd)
        //設定位置大小
        printsBtn.frame = CGRect(x: 144.0, y: 8.0, width: 40.0, height: 40.0)
        //設定觸發事件
        printsBtn.addTarget(self, action: #selector(printsBtnSelector(_:)), for: .touchUpInside)
        //背景顏色
        printsBtn.backgroundColor = UIColor.green
        //圓角
        printsBtn.layer.cornerRadius = 10.0
        //識別碼
        printsBtn.tag = self.printsTag
        //建立printsImageView物件
        printsImageView = UIImageView(frame: CGRect(x: 5.0, y: 474.0, width: 200.0, height: 200.0))
        
        //允許編輯
        printsImageView.isUserInteractionEnabled = true
        //背景顏色
        printsImageView.backgroundColor = UIColor.gray
        //Button加入到printsImageView
        self.printsImageView.addSubview(self.printsBtn)
        //建立Label物件
        printsLabel = UILabel(frame: CGRect(x: 5.0, y: 674.0, width: 200.0, height: 30.0))
        //設定文字 字型及大小
        printsLabel.text = "PRINTS"
        printsLabel.font = UIFont(name: "Helvetica", size: 16.0)
        
        
        
        //建立Button物件
        passportBtn = UIButton(type: .contactAdd)
        //設定位置大小
        passportBtn.frame = CGRect(x: 144.0, y: 8.0, width: 40.0, height: 40.0)
        //設定觸發事件
        passportBtn.addTarget(self, action: #selector(passportBtnSelector(_:)), for: .touchUpInside)
        //背景顏色
        passportBtn.backgroundColor = UIColor.green
        //圓角
        passportBtn.layer.cornerRadius = 10.0
        //識別碼
        passportBtn.tag = self.passportTag
        //建立passportImageView物件
        passportImageView = UIImageView(frame: CGRect(x: 209.0, y: 474.0, width: 200.0, height: 200.0))
        //允許編輯
        passportImageView.isUserInteractionEnabled = true
        //背景顏色
        passportImageView.backgroundColor = UIColor.gray
        //Button加入ImageView
        self.passportImageView.addSubview(self.passportBtn)
        //建立Label物件
        passportLabel = UILabel(frame: CGRect(x: 209.0, y: 674.0, width: 200.0, height: 30.0))
        //設定文字 字型及大小
        passportLabel.text = "PASSPORT/I.D."
        passportLabel.font = UIFont(name: "Helvetica", size: 16.0)
        
        self.view.addSubview(self.pictureLabel)
        self.view.addSubview(self.picturesImageView)
        self.view.addSubview(self.vehiclesLabel)
        self.view.addSubview(self.vehiclesImageView)
        self.view.addSubview(self.printsLabel)
        self.view.addSubview(self.printsImageView)
        self.view.addSubview(self.passportLabel)
        self.view.addSubview(self.passportImageView)
    ...
    //觸發事件
    func pictureBtnSelector(_ sender:AnyObject)
    {
        print("有")
        //建立相機物件
        let pictureImagePicker:UIImagePickerController = UIImagePickerController()
        //設定類型
        ...
        //推送畫面
        self.present(pictureImagePicker, animated: true, completion: nil)
        self.tag = self.pictureTag
        
    }
    func vehiclesBtnSelector(_ sender:AnyObject)
    {
        print("有")
        //建立相機物件
        let pictureImagePicker:UIImagePickerController = UIImagePickerController()
        ...
        //推送畫面
        self.present(pictureImagePicker, animated: true, completion: nil)
        self.tag = self.vehiclesTag
    }
    func printsBtnSelector(_ sender:AnyObject)
    {
        print("有")
        //建立相機物件
        let pictureImagePicker:UIImagePickerController = UIImagePickerController()
    ...
    func passportBtnSelector(_ sender:AnyObject)
    {
        print("有")
        //建立相機物件
        let pictureImagePicker:UIImagePickerController = UIImagePickerController()
...
extension AddPhotoViewController:UIImagePickerControllerDelegate,UINavigationControllerDelegate
{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        case 0:
            ...
            self.picturesImageView.image = image
        case 1:
            let image = info["UIImagePickerControllerEditedImage"] as! UIImage
            self.vehiclesImageView.image = image
        case 2:
            let image = info["UIImagePickerControllerEditedImage"] as! UIImage
            self.printsImageView.image = image
        case 3:
            let image = info["UIImagePickerControllerEditedImage"] as! UIImage
